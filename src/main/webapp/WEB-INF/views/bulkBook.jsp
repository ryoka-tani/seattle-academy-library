...
<body class="wrapper">
    ...
    <main>
        <form action="<%=request.getContextPath()%>/bulkBooks" method="post" enctype="multipart/form-data" id="data_upload_form">
            <h1>一括登録</h1>
            <div class="bulk_form">
                ...
                <div>
                    <input type="file" accept=".csv" id="upload_csv" name="uploadFile">
                </div>
